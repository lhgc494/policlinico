...
urlpatterns = [
    ...
    # API
    path('api/doctores/', views.doctores_por_especialidad, name='api_doctores'),
    ...
    # resultados
    path('laboratorio/ingresar-resultados/<int:examen_id>/',views.ingresar_resultados,name='ingresar_resultados'),
    path('laboratorio/imprimir-resultado/<int:examen_id>/',views.imprimir_resultado, name='imprimir_resultado'),
    path('api/consultas-dia/', views.api_consultas_dia, name='api_consultas_dia'),
    ]
