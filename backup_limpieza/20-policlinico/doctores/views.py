...
def atender_consulta(request, consulta_id):
    ...
    # ✅ CAMBIO: Usar catálogos dinámicos en lugar de listas estáticas
    ...
    # Formato: [('valor', 'texto'), ...] para los selects
    ...
    if request.method == 'POST':
        ...
        # ============================================
        # 5. FINALIZAR CONSULTA (GUARDAR DEFINITIVO)
        # ============================================
        elif 'guardar_definitivo' in request.POST:
            print(f"DEBUG - Guardando consulta {consulta_id}")

            # OBTENER DIAGNÓSTICO, OBSERVACIONES Y TRATAMIENTO
            ...
            consulta.estado = 'ATENDIDA'  # IMPORTANTE: Marcar como atendida
            consulta.save()

            print(f"DEBUG - Consulta actualizada. Diagnóstico guardado: '{consulta.diagnostico}'")

            # CREAR RECETAS DEFINITIVAS
            ...
            # CREAR EXÁMENES DE LABORATORIO DEFINITIVOS
            ...
            for examen_data in laboratorio_temp:
                ...
                if examen.startswith('OTRO:'):
                    tipo_examen = 'OTRO'
                    examen_especifico = examen[6:]  # Remover "OTRO: "
                else:
            ...
            for examen_data in ecografias_temp:
                ...
                if examen.startswith('OTRO:'):
                    ...
                    # ✅ CAMBIO: Usar 'ECOGRAFIA' en lugar de tipo específico
    ...
    context = {
        ...
        'examenes_laboratorio': examenes_laboratorio_list,  # Para el select
        'ecografias': ecografias_list,  # Para el select
        'examenes_laboratorio_objs': examenes_laboratorio,  # Para mostrar precios si necesitas
        'ecografias_objs': ecografias,  # Para mostrar precios si necesitas
        'recetas_temp': request.session.get('recetas_temp', []),
        'laboratorio_temp': request.session.get('laboratorio_temp', []),
        'ecografias_temp': request.session.get('ecografias_temp', []),
    }
