...
class Triaje(models.Model):
    ...
    # ==========================
    # En /home/luis/policlinico/triaje/models.py
# Función clean() COMPLETA y CORREGIDA:
    ...
    def clean(self):
        ...
        # 🚨🚨🚨 NUEVO: Saltar validación para consultas que NO necesitan triaje 🚨🚨🚨
        if self.consulta.tipo_consulta in ['LECTURA_RESULTADOS', 'ECOGRAFIA', 'TOPICO']:
            return  # 👈 Sale de la función, NO valida nada más
